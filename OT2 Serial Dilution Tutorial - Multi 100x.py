...
metadata = {
    'apiLevel': '2.13',
    'protocolName': 'Serial Dilution - 100x',
}
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    p300.pick_up_tip()
    p300.transfer(198, reservoir['A1'], plate.columns()[1:],new_tip='never')
    p300.return_tip()
    ...
    for source, destination in zip(row[:10], row[1:11]):
        ...
        p20.transfer(2, source, destination, mix_after=(5, 20), new_tip='never')
